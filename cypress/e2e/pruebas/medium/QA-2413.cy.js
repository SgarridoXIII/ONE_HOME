...
describe('QA-2413 - Calendario_Día', () => {
  ...
  // Pulsamos sobre la pestaña "Día"
  it('step 4', () => {
    cy.get('.calendar-view_mode').eq(3).should('have.text', ' Día ').click()
    cy.wait(1000)
    cy.get('.cal-time.ng-star-inserted').should('include.text', '9 a.')
    cy.wait(1000)
    cy.get('.cal-time.ng-star-inserted').should('include.text', '9 p.')
    cy.wait(1000)
  });
