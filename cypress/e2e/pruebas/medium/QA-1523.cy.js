...
describe('QA-1523 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Ampliaciones pedido_Eliminar imagen_No', () => {
  ...
  // Desde la pestaña Ampliaciones pedido, pulsamos sobre una de las imágenes
  it('step 6', () => {
