...
describe('QA-1046 - Crear cita_Pestaña Día y hora_Anterior', () => {
  ...
  it('step 6', () => {
    ...
    cy.get('h3').should('contain.text','Tipo de recepción')
    cy.get('h3').should('contain.text','Tipo de entrega')
    cy.get('h3').should('contain.text','Servicios de movilidad')
  });
