...
describe('QA-1468 - Recepciones_Detalle del pedido_Multimedia_Eliminar vídeo_No', () => {
  ...
  it('step 8', () => {
    ...
    cy.wait(1000)
    cy.get('div[class="col d-flex justify-content-between align-items-center"] :nth-child(2)').click()
    cy.wait(1000)
    cy.get('one-video').should('be.ok')
    cy.wait(1000)
  });
