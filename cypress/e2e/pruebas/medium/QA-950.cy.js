...
describe('QA-950 - Crear cita_Pestaña Intervenciones_Siguiente', () => {
  ...
  //Pulsamos sobre la flecha Siguiente
  it('step 6', () => {
    cy.get(".navigation").click(1075, 75).wait(1000)
    cy.wait(1000)
    cy.get('h3').should('include.text','Tipo de recepción')
    cy.get('h3').should('include.text','Tipo de entrega')
    cy.get('h3').should('include.text','Servicios de movilidad')
  });
