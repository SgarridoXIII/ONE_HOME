...
describe('Test QA-1545	Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Intervenciones_Siguiente', () => {
    ...
    it('Step 9',()=>{   // Accedemos a checklist
        cy.get('svg.navigation__navs__back').click()
        cy.xpath("//div[@class='mat-step-label mat-step-label-active'][contains(.,'Check list')]").click()     
        cy.get('div[class="checklistGroups"]').should("be.visible")   
    })
