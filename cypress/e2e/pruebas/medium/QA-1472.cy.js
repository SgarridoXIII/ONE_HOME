...
describe('QA-1472 - Recepciones_Detalle del pedido_Ampliaciones/CAM', () => {
  ...
  // Cogemos ampliaciones sin gestionar
  it('step 6', () => {
    ...
    cy.get('div[class="extensionAlert ng-star-inserted"]').should('have.text', 'Hay ampliaciones sin gestionar')
    cy.wait(1000)
  });
