...
describe('Test QA-1743 Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Estado del vehículo_Eliminar imagen', () => {
    ...
    it('Step 9',()=>{   //Pulsamos sobre la imagen
        cy.get('.card-container__preview').first().click()
    })
