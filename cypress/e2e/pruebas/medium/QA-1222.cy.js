...
describe('QA-1222 - Recepciones_Pestaña Todos', () => {
  ...
  // Comprobamos que, por defecto, sin realizar ninguna búsqueda, se muestra la pestaña Recepciones
  it('step 4', () => {
    cy.get('.mat-tab-labels :nth-child(2)').then(e => {
      expect(e.attr('aria-selected')).to.equal('true')
    })
    cy.wait(1000)
