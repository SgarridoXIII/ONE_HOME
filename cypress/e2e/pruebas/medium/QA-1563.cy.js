...
describe('Test QA-1563	Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Resumen_Seleccionar autorizaciones', () => {
  ...
  it('Step 7', () => {   // Resumen, comprobamos info
  ...
  it('Step 8', () => {   //marcamos autorizaciones
    cy.get('mat-checkbox').click({ multiple: true })
    ...
    cy.get('input[aria-checked="true"]').should("be.visible")
  })
