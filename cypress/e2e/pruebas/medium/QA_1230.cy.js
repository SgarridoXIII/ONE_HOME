...
describe('QA-1230 - Recepciones_Detalle del pedido_Información general_Desplegable_Estado', () => {
  ...
  //Pulsamos sobre el campo Tipo de recepción
  it('step 6', () => {
    cy.get('mat-select[formcontrolname="appointmentType"]').should('not.be.enabled')
  });
