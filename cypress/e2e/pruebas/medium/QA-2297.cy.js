...
describe('QA-2297 - E2E_Entregas', () => {
  ...
  // Hacemos click en el campo "Vehículo"
  it('step  4', () => {
    ...
    cy.wait(1000)
    cy.get('h4').should('include.text', 'Seleccionar vehículo')
    cy.wait(1000)
  });
  
  // Seleccionamos un vehículo de la lista
  it('step 5', () => {
  ...
  // Hacemos click en el campo "Cliente" e introducimos un criterio de busqueda
  it('step 6', () => {
    cy.get('mat-icon').should('have.text', 'close').click()
    cy.wait(1000)
  ...
  // Hacemos click en el campo "Asesor"
  it('step 8', () => {
    cy.get('mat-icon').should('have.text', 'close').click()
    cy.wait(5000)
    cy.get('.mat-form-field-flex').eq(2).click()
    cy.wait(1000)
    cy.get('input[formcontrolname="search"]').type(asesor)
    cy.wait(1000)
  });
  
  // Seleccionamos un Asesor de la lista
  it('step 9', () => {
    cy.get('one-card-advisor').eq(0).click()
    cy.wait(1000)
  });
  
  // Pulsamos sobre un resultado de la tabla
  it('step 10', () => {
    cy.get('one-card-appointment').eq(0).click()
    cy.wait(1000)
  });

  // Pulsamos sobre el botón de "Volver"
  it('step 11', () => {
