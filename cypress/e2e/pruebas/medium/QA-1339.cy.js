...
describe('Test QA-1339 - Recepciones_Detalle del pedido_Diferidos_Añadir diferidos', () => {
  ...
  it('step 5', () => {
    cy.xpath("//span[@class='sidebar__option__text'][contains(.,'Diferidos')]").click()
  });

  // Pulsamos sobre el botón añadir diferidos
  it('step 6', () => {
    cy.xpath("//button[@class='btn__secondary'][contains(.,'Añadir diferido')]").click()
    cy.wait(1000)
    cy.xpath("//h4[@class='m-0 bold'][contains(.,'Añadir intervenciones')]").should("be.visible")
  });
