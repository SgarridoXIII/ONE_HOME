...
describe('QA-1476 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Healthcheck CAM_Añadir intervención_Cambio estado_Aceptar', () => {
  ...
  // Desde la pestaña Healthcheck CAM, pulsamos el botón Añadir intervención
  it('step 6', () => {
