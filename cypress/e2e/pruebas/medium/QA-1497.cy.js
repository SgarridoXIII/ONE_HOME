...
describe('QA-1497 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Healthcheck CAM_Eliminar intervención_Cancelar', () => {
  ...
  // Desde la pestaña Healthcheck CAM, pulsamos el botón Eliminar intervención
  it('step 6', () => {
  ...
  // Pulsamos Cancelar
  it('step 7', () => {
    cy.get('mat-dialog-container').find('button.btn__secondary').click()
    cy.wait(1000)
    cy.get('mat-expansion-panel').should('be.ok')
    cy.wait(1000)
  });
