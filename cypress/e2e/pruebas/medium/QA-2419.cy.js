...
describe('QA-2419 - Calendario_CrearNuevaCita_ConUsuario', () => {
  ...
  // Hacemos click en un día del mes teniendo seleccionado el usuario en el campo "Usuario" con el que nos hemos logeado
  it('step 4', () => {
