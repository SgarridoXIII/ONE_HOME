...
describe('QA-1327 - Recepciones_Detalle del pedido_Intervenciones_Añadir intervención_Sugerida', () => {
  ...
  it('step 5', () => {
    cy.get('.sidebar__option__text').contains('Intervenciones').click()
    cy.wait(1000)
  });

  // Pulsamos el botón Añadir intervención
  it('step 6', () => {
    cy.get('div[class="d-flex flex-column flex-lg-row container__action"]').find('button').eq(0).click()
    cy.wait(1000)
  });
  
  // Añadimos una intervención sugerida
  it('step 7', () => {
