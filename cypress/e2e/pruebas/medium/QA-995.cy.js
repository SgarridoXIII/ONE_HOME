...
describe('QA-995 - Crear usuario_pestaña Datos usuarios_obligatoriedad campos_Rol', () => {
  ...
  //Completamos los campos del formulario menos el campo "Rol", y pulsamos en el botón "Crear usuario".
  it('step 5', () => {
