...
describe('Test QA-1576 E2E_Recepciones_Detalle del pedido_Intervenciones_Añadir intervención_Iniciar recepción_Finalizar', () => {
    ...
    it('Step 7', () => {    //Nos colocamos en la pestaña Intervenciones y pulsamos añadir intervencion
    ...
    it('Step 8', () => {   // Añadimos intervencion y pulsamos iniciar recepcion
        cy.get(':nth-child(6) > .col > .row > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').scrollIntoView().type("Test intervencion")
