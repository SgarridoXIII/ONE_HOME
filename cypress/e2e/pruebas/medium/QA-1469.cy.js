...
describe('QA-1469 - Recepciones_Detalle del pedido_Multimedia_Editar imagen', () => {
  ...
  // Editamos la imagen, el campo Categoría y/o editamos el campo Comentarios y pulsamos Guardar
  it('step 7', () => {
    cy.get('textarea[formcontrolname="comments"]').type('TestEdit')
    cy.wait(1000)
