...
describe('QA-1343 - Recepciones_Detalle del pedido_Diferidos_Añadir diferidos_Seleccionar intervención_Cancelar', () => {
  ...
  //Rellenamos el campo Fecha y pulsamos Cancelar
  it('step 9', () => {
