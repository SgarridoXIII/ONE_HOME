...
describe('QA-1231 - Recepciones_Detalle del pedido_Información general_Desplegable_Tipo de entrega', () => {
  ...
  //Pulsamos sobre el campo Tipo de entrega
  it('step 6', () => {
    cy.get('mat-select[formcontrolname="deliveryType"]').should('not.be.enabled')
  });
