...
describe('QA-1499 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Ampliaciones pedido_Eliminar intervención', () => {
  ...
  // Desde la pestaña Ampliaciones pedido, pulsamos el botón Eliminar intervención 
  it('step 6', () => {
  ...
  // Pulsamos Eliminar
  it('step 7', () => {
    cy.get('button.btn__primary').click()
    cy.wait(1000)
