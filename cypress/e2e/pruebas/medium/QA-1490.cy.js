...
describe('QA-1490 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Ampliaciones pedido_Enviar ampliación pedido (sin vídeo)_Confirmar_Descartar', () => {
  before(() => {
  ...
  // Desde la pestaña Ampliaciones pedido, pulsamos el botón Enviar ampliación
  // pedido (deben existir ampliaciones en estado Pdte comunicación cliente y el 
  // selector Mostrar vídeo en Amplicación pedido (al pulsar sobre un vídeo añadido 
  // en la pestaña) debe estar deshabilitado.)
  it('step 6', () => {
