...
describe('QA-1501 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Ampliaciones pedido_Añadir intervención_Cambio pagador', () => {
  ...
  it('step 8', () => {
    ...
    cy.wait(1000)
    cy.get('.btn__primary').should('include.text', 'Aceptar')
    cy.wait(1000)
  });
