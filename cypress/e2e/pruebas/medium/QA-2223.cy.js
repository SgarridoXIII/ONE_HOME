...
describe('QA-2223 - Ampliaciones pedidos_PedidosEnCurso', () => {
  ...
  // Pulsamos la pestaña "Pedidos en curso"
  it('step 4', () => {
    cy.get('.mat-tab-label-content').eq(0).should('have.text', 'Pedidos en curso')
    cy.wait(1000)
    cy.get('.mat-tab-label-content').eq(0).click()
    cy.wait(1000)
