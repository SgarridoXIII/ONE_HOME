...
describe('QA-1354 - Recepciones_Detalle del pedido_Checklist_Hueco motor', () => {
  ...
  // Pulsamos sobre la pestaña Hueco motor
  it('step 6', () => {
    cy.get('div[class="checklistGroups"] :nth-child(4)').click()
    cy.wait(1000)
    cy.get('div[class="checklistGroups"] :nth-child(4)').should('include.text', 'Hueco motor')
    cy.wait(1000)
 });
