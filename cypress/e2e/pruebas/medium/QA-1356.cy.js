...
describe('QA-1356 - Recepciones_Detalle del pedido_Checklist_Neumáticos', () => {
  ...
  // Pulsamos sobre la pestaña Neumáticos
  it('step 6', () => {
    cy.get('div[class="checklistGroups"] :nth-child(6)').click()
    cy.wait(1000)
    cy.get('div[class="checklistGroups"] :nth-child(6)').should('include.text', 'Neumáticos')
    cy.wait(1000)
 });
