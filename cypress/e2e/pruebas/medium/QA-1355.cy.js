...
describe('QA-1355 - Recepciones_Detalle del pedido_Checklist_Vehículo elevado', () => {
  ...
  // Pulsamos sobre la pestaña Vehículo elevado
  it('step 6', () => {
    cy.get('div[class="checklistGroups"] :nth-child(5)').click()
    cy.wait(1000)
    cy.get('div[class="checklistGroups"] :nth-child(5)').should('include.text', 'Vehículo elevado')
    cy.wait(1000)
 });
