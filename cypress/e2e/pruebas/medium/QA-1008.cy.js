...
describe('QA-1008 - Instalaciones_Actualizar instalaciones', () => {
...
before(() => {
  ...
  //En la pantalla "Instalaciones" pulsamos en el botón "Actualizar instalaciones".
  it('step 6', () => {
    cy.get('button[class="btn__secondary"]').click()
  });
