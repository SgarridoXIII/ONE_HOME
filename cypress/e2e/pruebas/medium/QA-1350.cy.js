...
describe('QA-1350 - Recepciones_Detalle del pedido_Check list', () => {
  ...
  it('step 5', () => {
    ...
    cy.wait(1000)
    cy.get('one-check-list-service').should('be.ok')
    cy.wait(1000)
    cy.get('div').should('include.text','Lunas')
    cy.get('div[class="checklistGroups__group ng-star-inserted"]').should('include.text','Exterior')
    cy.get('div[class="checklistGroups__group ng-star-inserted"]').should('include.text','Interior')
    cy.get('div[class="checklistGroups__group ng-star-inserted"]').should('include.text','Hueco motor')
    cy.get('div[class="checklistGroups__group ng-star-inserted"]').should('include.text','Vehículo elevado')
    cy.get('div[class="checklistGroups__group ng-star-inserted"]').should('include.text','Neumáticos')
  });
