...
describe('QA-1090 - Usuarios_Buscador', () => {
  ...
  //Realizamos una busqueda en el buscador
  it('step 6', () => {
    cy.get('#mat-input-0').type(busquedaUser)
    cy.wait(1000)
    cy.get('.card-user__content__user-info__name > .ng-star-inserted').should('include.text', busquedaUser)
  });
