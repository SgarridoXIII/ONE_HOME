...
describe('QA-2495 - Clientes_DetallesCliente_ORs', () => {
  ...
  // Pulsamos sobre uno de los clientes
  it('step 4', () => {
    cy.get('one-card-customer').eq(0).click()
    cy.wait(1000)
  });
  
  // Pulsamos sobre la pestaña "ORs"
  it('step 5', () => {
    cy.get('#mat-tab-label-0-2').click()
    cy.wait(1000)
  });
  
  // Hacemos click sobre uno de los registros de la lista
  it('step 6', () => {
  ...
  it('step 7', () => {
    ...
    cy.wait(1000)
    cy.get('one-detail-customers.ng-star-inserted').should('be.ok')
    cy.wait(1000)
  });
