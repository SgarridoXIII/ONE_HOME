...
describe('Test QA-1541 Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Estado del vehículo_Añadir vídeo', () => {
    ...
    it('Step 8', () => {   //Pulsamos añadir video
        cy.get(':nth-child(3) > .damages__add-damage').click()
    })

    it('Step 9', () => {   //Añadimos video
        cy.get('.fileInput').attachFile(video).wait(8000)
