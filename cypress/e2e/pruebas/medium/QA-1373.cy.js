...
describe('QA-1373 - Recepciones_Detalle del pedido_Checklist incompleta', () => {
  ...
  // Dejamos sin rellenar algunos módulos de algunas pestañas
  it('step 6', () => {
  ...
  // Comprobamos que en el menú lateral izquierdo, aparece junto al nombre de la pestaña, el icono rojo
  it('step 7', () => {
    cy.get('svg[matTooltip="Check list incompleta"]').should('be.ok')
    cy.wait(1000)
  });
