...
describe('QA-2399 - Gestionar diferidos_Matrícula', () => {
  ...
  // Introducimos una matrícula válida en el campo "Matrícula"
  it('step 4', () => {
    cy.get('input[formcontrolname="license"]').type(matricula)
    cy.wait(1000)
    cy.get('one-card-package-deferred').eq(0).should('include.text', matricula)
    cy.wait(1000)
  });
