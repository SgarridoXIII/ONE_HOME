...
describe('Test QA-1334 - Recepciones_Detalle del pedido_Intervenciones_Diferir intervención_Seleccionar fecha', ()=>{
  ...
  it('Step 7',()=>{   //Seleccionamos fecha
    cy.xpath("//mat-form-field[@appearance='outline'][contains(.,'Fecha')]").click()
  })

  it('Step 8',()=>{   //Seleccionamos año y mes 
    for(let i = 0 ; i < 2; i++){
  ...
  it('Step 9',()=>{   //Seleccionamos dia
    cy.xpath("//div[@class='mat-calendar-body-cell-content mat-focus-indicator'][contains(.,'13')]").click().wait(2000)
  })
