...
describe('QA-2427 - E2E_Calendario_CrearNuevaCita_CitaConCliente_Dia', () => {
  ...
  // Hacemos click en una hora del día en la pestaña "Día"
  it('step 4', () => {
    cy.get('.calendar-view_mode').eq(3).should('have.text', ' Día ').click()
    cy.wait(1000)
    cy.get('.cal-hour.ng-star-inserted').eq(2).click()
    cy.wait(1000)
  });
