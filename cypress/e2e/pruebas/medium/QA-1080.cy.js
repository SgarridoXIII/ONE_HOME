...
const ObjBuscar = 'PINZAS'

describe('QA-1080 - Recambios_Buscador', () => {
  ...
  it('step 6', () => {
    cy.get('input[formcontrolname="search"]').type('Pinzas{enter}')
    cy.wait(20000)
    cy.get('mat-cell[class="mat-cell cdk-cell cdk-column-name mat-column-name ng-star-inserted"]').should('contain.text',ObjBuscar)
  });
