...
describe('QA-1479 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Healthcheck CAM_Enviar ampliación CAM (sin vídeo)_Confirmar_Descartar', () => {
  ...
  // Mostrar vídeo en Health Check (al pulsar sobre un vídeo añadido en la pestaña) debe estar deshabilitado.)
  it('step 6', () => {
  ...
  // Abrimos el email del cliente y rechazamos la ampliación
  it('step 8', () => {
