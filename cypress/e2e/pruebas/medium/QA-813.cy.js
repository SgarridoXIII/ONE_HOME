...
describe('QA-813 - E2E_Crear cliente_Empresa_Usar la misma dirección', () => {
  ...
  //En la pantalla "Crear cliente" rellanamos los campos correspondientes del formulario, el campo "Usar la misma dirección" activado. Pulsamos en el botón "Crear cliente".
  it('step 5', () => {
