...
describe('QA-1353 - Recepciones_Detalle del pedido_Checklist_Interior', () => {
  ...
  // Pulsamos sobre la pestaña Interior
  it('step 6', () => {
    cy.get('div[class="checklistGroups"] :nth-child(3)').click()
    cy.wait(1000)
    cy.get('div[class="checklistGroups"] :nth-child(3)').should('include.text', 'Interior')
    cy.wait(1000)
 });
