...
describe('QA-1484 - Recepciones_Detalle del pedido_Ampliaciones/CAM_Healthcheck CAM_Enviar ampliación CAM (con vídeo)_Confirmar_Autorizar', () => {
  ...
  // Desde la pestaña Healthcheck CAM, pulsamos el botón Enviar ampliación CAM 
  // (deben existir ampliaciones en estado Pdte comunicación cliente y el selector 
  // Mostrar vídeo en Health Check (al pulsar sobre un vídeo añadido en la pestaña) debe estar habilitado.)
  it('step 6', () => {
    ...
    cy.wait(1000)
    cy.get('h4').should('have.text', 'Enviar amplicación CAM')
    cy.wait(1000)
  });
  ...
  // Abrimos el email del cliente y autorizamos la ampliación - se agrega validacion de envio de email
  it('step 8', () => {
