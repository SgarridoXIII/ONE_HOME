...
describe('Test QA-1526 Recepciones_Detalle del pedido_Recepción_Cancelar recepcion', () => {
  ...
  it('Step 6',()=>{   //Pulsamos boton cancelar recepcion
    cy.xpath("//button[contains(.,'Cancelar recepción')]").click()
  })

  it('Step 7',()=>{   //Pulsamos confirmar cancelacion
