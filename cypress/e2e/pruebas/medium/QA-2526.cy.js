...
describe('QA-2526 - Vehículos_DetallesVehículo_ORs', () => {
  ...
  // Pulsamos en un vehículo
  it('step 4', () => {
    cy.get('.card-vehicle__content').eq(0).click()
    cy.wait(1000)
  });
  
  // Pulsamos en la pestaña "Pedidos"
  it('step 5', () => {
    cy.get('#mat-tab-label-0-1').click()
    cy.wait(1000)
    cy.get('.row').should('be.ok')
    cy.wait(1000)
    cy.get('input[formcontrolname="serviceNumber"]').should('be.ok')
    cy.wait(1000)
  });
