...
describe('QA-1361 - Recepciones_Detalle del pedido_Checklist_Lunas_Añadir imagen', () => {
  ...
  // Pulsamos el icono Añadir imagen
  it('step 8', () => {
    cy.get('svg[class="icon pointer ng-star-inserted"]').eq(1).click()
    cy.wait(1000)
    cy.get('one-add-edit-damage').should('be.ok')
    cy.wait(1000)
  });
