...
describe('QA-956 - Crear usuario_Datos usuario_formato campos_Apellido2', () => {
  ...
  //Comprobamos que el formato del campo Apellido2 es correcto
  it('step 5', () => {
    cy.get('input[formcontrolname="secondSurname"]').type(`secondname${generateRandomNumber()}`)
