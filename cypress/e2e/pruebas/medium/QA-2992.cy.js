...
describe('QA-2992 - Creación de un cliente Empresa', () => {
  ...
  // Desde la pantalla "Crear cliente". Seleccionamos la opción "Empresa"
  it('step 3', () => {
    cy.get('.btn__secondary.mr-2.ng-star-inserted').eq(1).click()
    cy.wait(1000)
  });
  ...
  it('step 4', () => {
    ...
    cy.wait(1000)
    cy.get('input[formcontrolname="businessName"]').type(`Test${generateRandomNumber()}`)
    cy.wait(1000)
