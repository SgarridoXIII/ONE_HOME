...
describe('QA-2416 - Calendario_Usuario', () => {
  ...
  // Hacemos click sobre un resultado de la lista de usuarios
  it('step 5', () => {
    cy.get('one-card-advisor').eq(0).click()
    cy.wait(1000)
    cy.get('.mat-input-element.mat-form-field-autofill-control').then(e => {
      expect(e.val()).to.include(asesor)
    })
    cy.wait(1000)
  });
