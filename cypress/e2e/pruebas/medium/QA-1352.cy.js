...
describe('QA-1352 - Recepciones_Detalle del pedido_Checklist_Exterior', () => {
  ...
  // Pulsamos sobre la pestaña Exterior
  it('step 6', () => {
    cy.get('div[class="checklistGroups"] :nth-child(2)').click()
    cy.wait(1000)
    cy.get('div[class="checklistGroups"] :nth-child(2)').should('include.text', 'Exterior')
    cy.wait(1000)
 });
