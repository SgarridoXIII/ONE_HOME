...
describe('QA-1079 - Recambios_Subir fichero_Subir fichero_Cancelar', () => {
  ...
  //Pulsamos sobre 'Seleccionar fichero'
  it('step 7', () => {
    cy.get('.ml-2').click()
    cy.wait(1000)
  });

  //Cerramos la pantalla sin seleccionar fichero y pulsamos ahora sobre el botón 'Examinar'
  it('step 8', () => {
    cy.get('input[formcontrolname="file"]').click()
  });
