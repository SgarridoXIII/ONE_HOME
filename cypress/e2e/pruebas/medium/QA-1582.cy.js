...
describe('Test QA-1582 E2E_Recepciones_Detalle del pedido_Multimedia_Añadir archivo_Iniciar recepción_Finalizar', () => {
    ...
    it('Step 7', () => {    //Nos colocamos en la pestaña Multimedia
        cy.contains("Multimedia").click()
        cy.get('.icon-doc').click()
        cy.wait(1000)
    })

    it('Step 8', () => {   //Añadimos archivos e iniciamos recepcion 
