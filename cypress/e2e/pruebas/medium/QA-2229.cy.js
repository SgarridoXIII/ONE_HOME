...
describe('QA-2229 - Ampliaciones pedidos_HistóricoDePedidos', () => {
  ...
  // Pulsamos sobre la pestaña "Histórico de pedidos"
  it('step 4', () => {
    cy.get('.mat-tab-label-content').eq(2).should('have.text', 'Histórico de pedidos')
    cy.wait(1000)
