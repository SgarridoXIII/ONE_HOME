...
describe('Test QA-1600 E2E_Recepciones_Detalle del pedido_Entrega_Iniciar recepción_Finalizar', () => {
    ...
    it('Step 7', () => {
        ...
        cy.get('.sidebar__option__text').contains('Entrega').click() //Ir a la pestaña entrega
        cy.wait(3000)
