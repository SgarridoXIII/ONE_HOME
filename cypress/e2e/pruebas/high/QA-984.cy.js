...
const cliente = '0311X - M. CONDE'

describe('Test QA-984 - Crear cita_Pestaña Servicios adicionales_Tipo de recepción', ()=>{
  ...
  // Seleccionamos uno de los tipos de recepción
  it('step 6', () => {
    cy.get('.w-100 > :nth-child(1) > :nth-child(2) > :nth-child(2)').click()
    cy.wait(1000)
  });
