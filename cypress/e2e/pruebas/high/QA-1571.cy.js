...
describe('Test QA-1571 E2E_Recepciones_Detalle del pedido_Cliente_Iniciar recepción_Finalizar', () => {
    ...
    it('Step 7', () => {
        ...
        cy.get('.sidebar__option__text').contains('Cliente').click() //Ir a la pestaña cliente
        cy.wait(3000)
