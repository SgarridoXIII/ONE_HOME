...
describe('Test QA-1346	Recepciones_Detalle del pedido_Diferidos_Descartar', () => {
    ...
    it("Step 5", () => {
        ...
        cy.get('form.ng-touched > :nth-child(2) > .col-12 > .btn__primary').click({force:true})
        ...
        cy.xpath("//div[@class='mat-calendar-body-cell-content mat-focus-indicator mat-calendar-body-today']").click().wait(2000)
