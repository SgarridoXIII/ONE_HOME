...
describe('Test QA-1560 Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Resumen_Eliminar intervención', () => {
    ...
    it("Step 5", () => {
        cy.wait(3000)
        cy.get('.sidebar__option').children('.sidebar__option__text').contains('Información general').click().wait(3000)
    })
    it("Step 6", () => {
    ...
    it("Step 8", () => {
        cy.get('svg[matTooltip="Eliminar"]').first().click({force:true})
        cy.wait(3000)
