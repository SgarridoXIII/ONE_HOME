...
describe('Test QA-1562	Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Resumen_Descartar intervención', () => {
    ...
    it("Step 5", () => {
        cy.get('.sidebar__option').children('.sidebar__option__text').contains('Información general').click().wait(1000)
    })
    it("Step 6", () => {
    ...
    it("Step 8", () => {
        cy.get('svg[matTooltip="Descartar"]').first().click({force:true})
