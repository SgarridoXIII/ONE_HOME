...
describe('Test QA-1606 E2E_Recepciones_Detalle del pedido_Iniciar recepción_Autorizaciones_Finalizar', () => {
    ...
    it("Step 5", () => {
        // cy.get('svg.app-bar__back__icon use[xlink:href="/assets/icons/sprite.svg#aui-icon-cancel-large"]').click();
        cy.visit("/",)
        cy.wait(2000)
