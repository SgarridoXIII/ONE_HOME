...
describe('Test QA-1067	Crear cita_Pestaña Confirmación_Confirmar cita', () => {
    ...
    // Comprobamos todos los datos que aparecen en la pestaña y pulsamos el botón Confirmar cita
    it("Step 6", () => {
        cy.wait(3000)
