...
describe('Test QA-1603 - E2E_Recepciones_Detalle del pedido_Iniciar recepción_Añadir nuevas intervenciones_Finalizar', () => {
  ...
  // En la pestaña Intervenciones, pulsamos el botón Añadir nuevas intervenciones
  it('step 9', () => {
  ...
  // Añadimos una intervención, y pulsamos el botón Finalizar
  it('step 10', () => {
