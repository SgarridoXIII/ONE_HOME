...
describe('Test QA-981	Crear cita_Pestaña Servicios adicionales_Siguiente', () => {
    ...
    it("Step 6", () => {
        ...
        cy.get('.w-100 > :nth-child(3) > :nth-child(2) > :nth-child(2)').click().wait(1000)
        cy.get('svg.navigation__navs__back').click().wait(1000)
