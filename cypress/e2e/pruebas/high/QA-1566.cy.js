...
describe('Test QA-1566 Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Resumen_Obligatoriedad firma asesor', () => {
    ...
    it("Step 8", () => {
        ...
        cy.wait(2000)
        cy.get(':nth-child(2) > .signature > one-signature-box > section > .actions > [mattooltip="Eliminar"]').click()
        cy.wait(2000)
