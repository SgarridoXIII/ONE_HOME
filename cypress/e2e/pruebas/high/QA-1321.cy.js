...
describe('QA-1321	Recepciones_Detalle del pedido_Resumen pedido_Intervenciones diferidas', () => {
    ...
    it("Step 7", () => {
        cy.wait(2000)
        cy.contains('Recambios').should("be.visible")
        cy.contains('Mano de obra').should("be.visible")
        cy.contains('Fluidos').should("be.visible")
    })
