...
describe(' Test QA-890 - Crear vehículo_obligatoriedad campos_Cliente', ()=>{
  ...
  // Completamos los campos del formulario menos el campo "Cliente", y pulsamos en el botón "Crear vehículo".
  it('step 5', () => {
