...
describe('Test QA-938	Crear cita_Pestaña Motivo de la visita_Seleccionar motivo de visita', () => {
    ...
    it("Step 6", () => {
        cy.contains('Mantenimiento').click({ force: true })
        cy.wait(1000)
    })
    it("Step 7", () => {
        cy.get('div.col svg.icon')
  .eq(0)
  .click();
