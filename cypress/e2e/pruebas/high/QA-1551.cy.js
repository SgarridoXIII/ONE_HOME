...
describe('Test QA-1551	Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Check list_Anterior', () => {
    ...
    it("Step 7", () => {
        ...
        cy.contains('Exterior').click().wait(500)
        cy.get(':nth-child(1) > .checklistItems__checklistItem__statuses > .checklistItems__checklistItem__statuses__status--green').click()
        cy.contains('Interior').click().wait(500)
        cy.get(':nth-child(1) > .checklistItems__checklistItem__statuses > .checklistItems__checklistItem__statuses__status--green').click()
        cy.contains('Hueco motor').click().wait(500)
        cy.get(':nth-child(1) > .checklistItems__checklistItem__statuses > .checklistItems__checklistItem__statuses__status--green').click()
        cy.contains('Vehículo elevado').click().wait(500)
        cy.get(':nth-child(1) > .checklistItems__checklistItem__statuses > .checklistItems__checklistItem__statuses__status--green').click()
        cy.contains('Neumáticos').click().wait(500)
        cy.get(':nth-child(1) > .checklistItems__checklistItem__statuses > .checklistItems__checklistItem__statuses__status--green').click()
