...
describe('Test QA-1549 - Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Intervenciones_Eliminar', ()=>{
  ...
  it('step 6', () => {
    ...
    cy.wait(1000)
    cy.xpath("//button[@class='btn__primary w-100'][contains(.,'Aceptar')]").wait(4000).click()
    cy.wait(1000)
  });
  ...
  // Pulsamos Eliminar en una de las intervenciones
  it('step 8', () => {
