...
describe('Test QA-1573 - E2E_Recepciones_Detalle del pedido_Vehículo_Iniciar recepción_Finalizar', () => {
  ...
  // Rellenamos todas las pestañas correctamente y desde la pestaña Vehículo, pulsamos el botón Iniciar recepción
  it('step 7', () => {
