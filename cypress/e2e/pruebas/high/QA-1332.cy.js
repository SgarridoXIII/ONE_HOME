...
describe('Test QA-1332 - Recepciones_Detalle del pedido_Intervenciones_Eliminar intervención', ()=>{
  ...
  // Pulsamos sobre el botón Eliminar una intervención
  it('step 6', () => {
    cy.get('.col > [matTooltip="Eliminar"]').first().click()
    cy.wait(1000)
    cy.get('.col-12 > .btn__primary').click().wait(3000)
  });
