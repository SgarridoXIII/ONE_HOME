...
describe('Test QA-1546	Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Intervenciones_Añadir nuevas intervenciones', () => {
    ...
    it("Step 8", () => {
        cy.get('.flex-auto > .btn__primary').click().wait(1000)
       
    })
    it("Step 9", () => {
        cy.get(':nth-child(6) > .col > .row > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').as('add')
