...
describe('Test QA-1555 - Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Día y Hora (Entrega)_Anterior', ()=>{
  ...
  // Desde la pestaña Día y hora (Entrega), pulsamos sobre el nombre de la pestaña Check list
  it('step 9', () => {
    cy.get('#cdk-step-label-0-2').click()
    cy.wait(1000)
    cy.get('.checklistGroups__group').should(el => {
