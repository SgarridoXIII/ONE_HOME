...
describe('Test QA-1318	Recepciones_Detalle del pedido_Resumen pedido_Imprimir pedido', () => {
    ...
    it("Step 5", () => {
        cy.wait(3000)
        cy.get('.sidebar__option').children('.sidebar__option__text').contains('Resumen Pedido').click().wait(2000)
    })
    it("Step 6", () => {
        cy.get('.actions__block').should("be.visible")
