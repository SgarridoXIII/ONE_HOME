...
describe('QA-1597 - E2E_Recepciones_Detalle del pedido_Recepción_Iniciar recepción_Finalizar', () => {
  ...
  // Rellenamos todas las pestañas correctamente y desde la pestaña Recepción, pulsamos el botón Iniciar recepción
  it('step 7', () => {
    cy.get('.sidebar > :nth-child(14)').click()
    cy.wait(1000)
