...
describe('Test QA-1565 Recepciones_Detalle del pedido_Información general_Iniciar recepción_Pestaña Resumen_Obligatoriedad firma cliente', () => {
    ...
    it("Step 8", () => {
        ...
        cy.get('.row > :nth-child(1) > .signature > one-signature-box > section > .signature-container > .ng-star-inserted > canvas').scrollIntoView().click(50, 50, {force: true})
        ...
        cy.wait(2000)
        cy.get('.row > :nth-child(1) > .signature > one-signature-box > section > .actions > [mattooltip="Eliminar"]').click()
        cy.wait(2000)
