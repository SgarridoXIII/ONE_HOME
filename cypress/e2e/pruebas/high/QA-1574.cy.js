...
describe('Test QA-1574 E2E_Recepciones_Detalle del pedido_Resumen pedido_Iniciar recepción_Finalizar', () => {
    ...
    it('Step 6', () => {
     ...
     it('Step 7', ()=>{
        ...
        cy.get('.sidebar__option__text').contains('Resumen Pedido').click() //Ir a la pestaña resumen del pedido
        cy.wait(3000)
    ...
    it('Step 9', ()=>{
        ...
        // End Check list   
        // Dia y Hora (Entrega)    
        cy.get('input[matinput][placeholder="Selecciona un asesor..."]').click().wait(1000)
        cy.contains('Cualquier asesor').click()
        cy.wait(8000)
        clickOnAvailableSlot()
        cy.get('svg.navigation__navs__next').click().wait(1000);
        // End Dia y Hora (Entrega)    
