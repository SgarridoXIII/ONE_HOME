...
describe('QA-1601 - E2E_Recepciones_Detalle del pedido_Entrega_Reasignar entrega_Iniciar recepción_Finalizar', () => {
  ...
  // Rellenamos todas las pestañas correctamente y desde la pestaña Entrega, pulsamos el botón Reasignar recepción
  it('step 7', () => {
  ...
  // Seleccionamos los datos y desde la pestaña Entrega, pulsamos el botón Iniciar recepción
  it('step 8', () => {
  ...
  // Rellenamos todas las pestañas y pulsamos el botón Finalizar
  it('step 10', () => {
