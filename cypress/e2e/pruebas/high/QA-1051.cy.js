...
describe('Test QA-1051	Crear cita_Pestaña Día y hora_Calendario_Entrega', () => {
    ...
    // Seleccionamos un asesor
    it("Step 8", () => {

        cy.get('.ng-valid > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').type('Alberto{enter}').wait(3000)
        cy.contains('Alberto').click().wait(3000)
    })

    // Pulsamos sobre la flecha siguiente en el calendario
    it("Step 9", () => {
        cy.get('.day-selector__next').click();
        cy.wait(1000)

    })

    // Pulsamos sobre la flecha anterior en el calendario
    it("Step 10", () => {
        cy.get('.day-selector__prev').click();
        cy.wait(1000)

    })

    // Comprobamos las horas que se muestran
    it("Step 11", () => {
        cy.wait(1000)
    })
